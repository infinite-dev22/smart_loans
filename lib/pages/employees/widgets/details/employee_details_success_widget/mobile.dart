...
class EmployeeDetailsSuccessMobile extends StatefulWidget {
  final int employeeId;

  const EmployeeDetailsSuccessMobile({super.key, required this.employeeId});

  @override
  State<EmployeeDetailsSuccessMobile> createState() =>
      _EmployeeDetailsSuccessMobileState();
}

class _EmployeeDetailsSuccessMobileState
    extends State<EmployeeDetailsSuccessMobile> {
