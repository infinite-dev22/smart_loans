                    ...
                    child: Column(
                      children: [
                        BlocBuilder<InterestMethodBloc, InterestMethodState>(
                          builder: (context, state) {
                            if (state.status == InterestMethodStatus.initial) {
                              context
                            ...
                            if (state.status == InterestMethodStatus.success) {
                              return SizedBox(
                                height: 50,
                        ...
                        BlocBuilder<InterestPeriodBloc, InterestPeriodState>(
                          builder: (context, state) {
                            if (state.status == InterestPeriodStatus.initial) {
                              context
                            ...
                            if (state.status == InterestPeriodStatus.success) {
                              return SizedBox(
                                height: 50,
                                child: DropdownButtonFormField2(
                                  decoration: const InputDecoration(
                        ...
                        BlocBuilder<RepaymentCycleBloc, RepaymentCycleState>(
                          builder: (context, state) {
                            if (state.status == RepaymentCycleStatus.initial) {
                              context
                            ...
                            if (state.status == RepaymentCycleStatus.success) {
                              return SizedBox(
                                height: 50,
                                child: DropdownButtonFormField2(
                                  decoration: const InputDecoration(
                        ...
                        BlocBuilder<InterestFormBloc, InterestFormState>(
                          builder: (context, state) {
                            if (state.status == InterestFormStatus.fixedRate) {
