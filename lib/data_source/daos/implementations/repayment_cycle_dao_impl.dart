...
class RepaymentCycleDaoImpl extends SimpleDao {
  @override
  Future<Map<String, dynamic>> fetch(int id) async {
    ...
    try {
      ...
      var response = await dio.get(
        Uri.https(appUrl, 'api/repayment-cycle/show/$id').toString(),
      );
  ...
  Future<List<dynamic>> fetchAll() async {
    ...
    try {
      ...
      var response = await dio.get(
        Uri.https(appUrl, 'api/repayment-cycle').toString(),
      );
  ...
  Future post(Map<String, dynamic> data) async {
    ...
    try {
      ...
      var response = await dio.post(
        Uri.https(appUrl, 'api/repayment-cycle/create').toString(),
  ...
  Future put(Map<String, dynamic> data, int id) async {
    ...
    try {
      ...
      var response = await dio.put(
        Uri.https(appUrl, 'api/repayment-cycle/update/$id').toString(),
        data: jsonEncode(data),
      );
  ...
  Future<List<Map<String, dynamic>>> search(String search) async {
    ...
    try {
      ...
      var response = await dio.get(
        Uri.https(appUrl, 'api/repayment-cycle/search/$search').toString(),
      );
  ...
  Future<dynamic> delete(int id) async {
    ...
    try {
      ...
      var response = await dio.get(
        Uri.https(appUrl, 'api/repayment-cycle/delete/single/$id').toString(),
      );
  ...
  Future<dynamic> deleteMultiple(List<int> ids) async {
    ...
    try {
      ...
      var response = await dio.delete(
        Uri.https(appUrl, 'api/repayment-cycle/delete/multiple/$ids')
            .toString(),
      );
