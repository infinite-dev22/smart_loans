...
class LoanCategoryDaoImpl extends SimpleDao {
  ...
  Future<Map<String, dynamic>> fetch(int id) async {
    ...
    try {
      ...
      var response = await dio.get(
        Uri.https(appUrl, 'api/loancategories/show/$id').toString(),
      );
  ...
  Future put(Map<String, dynamic> data, int id) async {
    ...
    try {
      ...
      var response = await dio.put(
        Uri.https(appUrl, 'api/loancategory/update/$id').toString(),
        data: jsonEncode(data),
      );
  ...
  Future<List<Map<String, dynamic>>> search(String search) async {
    ...
    try {
      ...
      var response = await dio.get(
        Uri.https(appUrl, 'api/loancategory/search/$search').toString(),
      );
  ...
  Future<dynamic> delete(int id) async {
    ...
    try {
      ...
      var response = await dio.get(
        Uri.https(appUrl, 'api/loancategory/delete/single/$id').toString(),
      );
  ...
  Future<dynamic> deleteMultiple(List<int> ids) async {
    ...
    try {
      ...
      var response = await dio.delete(
        Uri.https(appUrl, 'api/loancategory/delete/multiple/$ids').toString(),
      );
